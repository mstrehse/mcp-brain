...
// NewUpdateTemplateHandler creates a handler for updating existing task templates
func NewUpdateTemplateHandler(repo contracts.TaskTemplateRepository) func(context.Context, mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		templateJSON, err := request.RequireString("template")
		if err != nil {
			return mcp.NewToolResultError("Missing 'template' parameter: " + err.Error()), nil
...
// NewDeleteTemplateHandler creates a handler for deleting task templates
func NewDeleteTemplateHandler(repo contracts.TaskTemplateRepository) func(context.Context, mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		templateID, err := request.RequireString("template_id")
		if err != nil {
			return mcp.NewToolResultError("Missing 'template_id' parameter: " + err.Error()), nil
